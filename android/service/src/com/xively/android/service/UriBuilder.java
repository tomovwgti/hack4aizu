...
public class UriBuilder {
    ...
    /**
     * @param feedId parent of the datastream
     ...
     * @return url to all Datastream API endpoints
     */
    public Datastream datastreams(int feedId, String datastreamId) {
        return new Datastream(feedId, datastreamId);
    }

    /**
     * @param feedId indirect parent of the datapoint
     * @param datastreamId direct parent of the datapoint
    ...
    public class Datastream {
        ...
        private Datastream(int feedId, String datastreamId) {
            this.feedId = feedId;
        ...
        public String resource(String datastreamId, String urlParam) {
            return resources().concat("/").concat(datastreamId + "?" + urlParam);
        }
