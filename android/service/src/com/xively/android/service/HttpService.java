...
public class HttpService extends Service {
    ...
    public IBinder onBind(Intent intent) {
        return new IHttpService.Stub() {
            ...
            @Override
            public Response updateDatastream(int feedId, String datastreamId, String body)
                    throws RemoteException {
                return put(new UriBuilder().datastreams(feedId).resource(datastreamId), body,
                        apiKey);
            }
            ...
            // 追加API
            @Override
            public Response getDatapoints(int feedId, String datastreamId, String urlParam)
                    throws RemoteException {
                return get(new UriBuilder().datastreams(feedId).resource(datastreamId, urlParam),
                        apiKey);
            }

            @Override
            public Response deleteDatastream(int feedId, String datastreamId)
                    throws RemoteException {
                return delete(new UriBuilder().datastreams(feedId).resource(datastreamId), apiKey);
            }

            @Override
            public Response createDatapoint(int feedId, String datastreamId, String body)
                    throws RemoteException {
                return post(new UriBuilder().datapoints(feedId, datastreamId).resources(), body,
                        apiKey);
            }

            @Override
            public Response updateDatapoint(int feedId, String datastreamId, String datapointAt,
                    String body) throws RemoteException {
                return put(new UriBuilder().datapoints(feedId, datastreamId).resource(datapointAt),
                        body, apiKey);
            }

            @Override
            public Response getDatapoint(int feedId, String datastreamId, String datapointAt)
                    throws RemoteException {
                return get(new UriBuilder().datapoints(feedId, datastreamId).resource(datapointAt),
                        apiKey);
            }

            @Override
            public Response deleteDatapoint(int feedId, String datastreamId, String datapointAt)
                    throws RemoteException {
                return delete(
                        new UriBuilder().datapoints(feedId, datastreamId).resource(datapointAt),
                        apiKey);
            }
